...
python3 main.py --save-path models --num-agents 2 --layout overcooked_cramped_room_v0  --centralised --batch-size 128 --num-minibatches 4 --total-steps 2000000 --seed 2